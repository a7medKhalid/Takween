    ...
    <section class="bg-white ">
        ...
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:py-24 lg:px-6">
            <div class="max-w-screen-md mx-auto mb-8 text-center lg:mb-12">
                ...
                <p class="mb-5 font-light text-gray-500 sm:text-xl ">You are going to be redirected to BMC website where you can subscribe to membership and than your subscription will activate after a while or you can click refresh button to update now .</p>
                <div>
                    <script type="text/javascript" src="https://cdnjs.buymeacoffee.com/1.0.0/button.prod.min.js" data-name="bmc-button" data-slug="a7medkhalid" data-color="#0b2d45" data-emoji="💻"  data-font="Arial" data-text="subscribe" data-outline-color="#ffffff" data-font-color="#ffffff" data-coffee-color="#FFDD00" ></script>
                    <button wire:click="refresh" class="mt-4" type="button">
                        <div class="flex">
            ...
            <div class="space-y-8 lg:grid lg:grid-cols-3 sm:gap-6 xl:gap-10 lg:space-y-0">
                ...
                <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow  xl:p-8 ">
                    ...
                    <p class="font-light text-gray-500 sm:text-lg ">Best option for one simple project.</p>
                    ...
                    @if ($subscriptionType == 'free')
                       <p class="text-green-500">You are on starter subscription </p>
                    @endif
                </div>
                <!-- Pricing Card -->
                <div class="flex flex-col max-w-lg p-6 mx-auto text-center text-gray-900 bg-white border border-gray-100 rounded-lg shadow  xl:p-8 ">
                    ...
                    @if ($subscriptionType == 'basic')
                        @if($isSubscriptionActive)
                            <p class="text-green-500">Your subscription ends at {{$subscriptionEndDate}}</p>
                        @else
                            <p class="text-red-500">Your subscription has expired</p>
                        @endif
                    @endif
                </div>
                <!-- Pricing Card -->
